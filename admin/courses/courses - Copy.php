		...
		<div class="row">
			  ...
			  <div class="col-sm-6 col-md-4">
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<!-- Content Section -->
					<a href="image_recognition.php" style="text-decoration: none; color: inherit;">
			  ...
			  <div class="col-sm-6 col-md-4">
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<!-- Content Section -->
					<a href="image_puzzle.php" style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
			  ...
			  <div class="col-sm-6 col-md-4">
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<!-- Content Section -->
					<a href="music_therapy.php" style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
			  ...
			  <div class="col-sm-6 col-md-4">
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<!-- Content Section -->
					<a href="language.php" style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
			  ...
			  <div class="col-sm-6 col-md-4">
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<!-- Content Section -->
					<a href="write.php" style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
			  ...
			  <div class="col-sm-6 col-md-4">
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					<!-- Image Section -->
					<img src="../dashboard/images/card.png" alt="Speech Therapy" style="width: 100%; height: auto;">

					<!-- Content Section -->
					<a href="#" style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							<h4 class="card-title" style="font-weight: bold; margin: 0;">Playing with cards</h4>
							<p class="text-muted" style="margin-top: 5px;">Language lessons with the most popular teachers</p>
					...
					<!-- Footer Section with Button -->
					<div class="card-footer" style="text-align: right; padding: 15px; background-color: white; border-top: none;">
						<a href="#" style="background-color: #f9a825; border: none; color: white; padding: 10px 15px; border-radius: 15px; text-decoration: none; font-weight: bold;">
							Start
						</a>
					</div>
				</div>
			  ...
			  <div class="col-sm-6 col-md-4">
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<!-- Content Section -->
					<a href="emotions.php" style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
