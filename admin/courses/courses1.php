                ...
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<a  style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							...
							<p class="text-muted" style="margin-top: 5px;">Enhance Visual Learning with Engaging and Interactive Activities.</p>
                ...
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<a  style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							...
							<p class="text-muted" style="margin-top: 5px;">Engaging puzzle activities to enhance problem-solving and visual recognition.</p>
                ...
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<a  style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							...
							<p class="text-muted" style="margin-top: 5px;">Interactive musical activities to enhance emotional well-being and cognitive development.</p>
                ...
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<a  style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							...
							<p class="text-muted" style="margin-top: 5px;">Fun and interactive activities to enhance speech clarity, language skills, and confidence.</p>
                ...
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<a  style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							...
							<p class="text-muted" style="margin-top: 5px;">Interactive exercises to improve handwriting, spelling, and sentence formation.</p>
                ...
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<a  style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							...
							<p class="text-muted" style="margin-top: 5px;">Fun activities to teach kids about colors, dressing for the weather, and independence.</p>
                ...
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<a style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							...
							<p class="text-muted" style="margin-top: 5px;">Engaging activities to help kids identify emotions, build empathy, and express themselves confidently.</p>
                ...
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<a  style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							...
							<p class="text-muted" style="margin-top: 5px;">Interactive scenarios to help kids develop social skills, understand cues, and respond appropriately in different situations.</p>
                ...
                <div class="card" style="border-radius: 15px; box-shadow: 0 4px 8px rgba(0,0,0,0.1); overflow: hidden; max-width: 400px;">
					...
					<a style="text-decoration: none; color: inherit;">
						<div class="card-body" style="padding: 15px;">
							...
							<p class="text-muted" style="margin-top: 5px;">Engaging activities to teach kids polite greetings, sharing, taking turns, and respectful communication.</p>
