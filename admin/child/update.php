				...
				<form action='update_data.php?id=$id' method='post' enctype='multipart/form-data' name='register_form' id='register_form'>
					<div class='card'>
					  <div class='card-header'>
						<div class='card-title'>Edit $titles</div>
					  </div>
					  <div class='card-body'>
						<div class='row'>";
						...
						<div class='col-md-6 col-lg-4'>
							<div class='form-group'>
								...
								<select name='$name' class='form-control'>
									...
									<option value='Beginner (Basic Recognition & Interaction)'>Beginner (Basic Recognition & Interaction)</option>
									<option value='Intermediate (Cognitive & Motor Skill Development)'>Intermediate (Cognitive & Motor Skill Development)</option>
									<option value='Advanced (Logical Thinking & Social Skills)'>Advanced (Logical Thinking & Social Skills)</option>
								</select>
							</div>
						</div>";
					}
							...
							<div class='col-md-6 col-lg-4'>
								<div class='form-group'>
								  ...
								  <input
									...
									value='$datas'
								  />
								  <img src='uploads/$datas' width='40%'>
								</div>
							</div>";
						}
						if($type_only=="text" )
